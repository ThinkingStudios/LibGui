...
public class LibGuiTestClient {
	...
	private static Command<ServerCommandSource> openScreen(Function<MinecraftClient, LightweightGuiDescription> screenFactory) {
		return openScreen(ScreenTexts.EMPTY, screenFactory);
	}

	private static Command<ServerCommandSource> openScreen(Text title, Function<MinecraftClient, LightweightGuiDescription> screenFactory) {
		return context -> {
